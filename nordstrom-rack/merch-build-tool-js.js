...
document.getElementById('add-row').addEventListener('click', function () {
  ...
  if (rows.length >= 0) {
    document.getElementById('remove-row').innerHTML =
      '<button style="margin-left:20px;" class="btn btn-outline-danger" onclick="removeRow()">Remove Row</button>';
  }
  addRow();
});
  ...
  switch (columnSelect) {
    case 'column1':
      ...
      rowTemplate =
        '<div id="' +
        newRowID +
        '" style="padding-bottom:20px;border-bottom:1px solid #E6E6E6;">' +
        '<div class="row">' +
        '<div class="col-lg-6">' +
        '<div class="row">' +
        ...
        displayI +
        ' Image 1 Src</label>' +
        '<input type="text" placeholder="Image Source" class="form-control image-src" onchange="handleImage(' +
        n +
        ')" id="image-src-' +
        n +
        '">' +
        ...
        displayI +
        ' Image 1 Href</label>' +
        '<input type="text" placeholder="Image Href Link" class="form-control" id="image-href-' +
        n +
        '">' +
        '</div>' +
        '</div>' +
        ...
        displayI +
        ' Image 1 Alt</label>' +
        '<input type="text" placeholder="Image Alt Text" class="form-control" id="image-alt-' +
        n +
        '">' +
        '</div>' +
        '</div>' +
    ...
    switch (columnOrder[arrayOrder]) {
      case 1:
        ...
        tableRow[i] =
          ...
          href +
          "','?', WAT('nrtag_segment','tile" +
          i +
          '\')))=%%" target="_blank" style="margin:0;padding:0;"><img width="' +
          width +
          '" height="' +
          height +
          '" src="' +
          ...
          '" alt="' +
          alt +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:' +
          width +
          'px;"></a>\n        </th>\n    </tr>\n</table>\n';
      ...
      case 2:
        ...
        height2 = document.getElementById('my-image-' + rowIndex2)
          .naturalHeight;
        // Compile the table code for this row of inputs
        tableRow[i] =
          '<table class="row collapse no-bot-pad w100P" width="640" style="border-collapse:collapse;border-spacing:0;display:table;padding:0;position:relative;vertical-align:top;">\n    <tr>\n       <th style="margin:0;padding:0;">\n          <a href="%%=redirectTo(concat(\'' +
          href +
          "','?', WAT('nrtag_segment','tile" +
          i +
          '-1\')))=%%" target="_blank" style="margin:0;padding:0;"><img width="' +
          width +
          '" height="' +
          height +
          '" src="' +
          ...
          '" alt="' +
          alt +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:auto;"></a>\n      </th>\n     <th style="margin:0;padding:0;">\n          <a href="%%=redirectTo(concat(\'' +
          href2 +
          "','?', WAT('nrtag_segment','tile" +
          i +
          '-2\')))=%%" target="_blank" style="margin:0;padding:0;"><img width="' +
          width2 +
          '" height="' +
          height2 +
          '" src="' +
      ...
      case 3:
        ...
        height3 = document.getElementById('my-image-' + rowIndex3)
          .naturalHeight;
        // Compile the table code for this row of inputs
        tableRow[i] =
          '<table class="row collapse w100P" border="0" cellspacing="0" cellpadding="0" width="640" style="border-collapse:collapse;border-spacing:0;padding:0;vertical-align:top;width:100%;">\n    <tr>\n       <td width="' +
          width +
          '" style="-moz-hyphens:auto;-webkit-hyphens:auto;margin:0;padding:0;vertical-align:top;">\n             <a href="%%=redirectTo(concat(\'' +
          href +
          "', '?', WAT('nrtag_segment','tile" +
          i +
          '-1\')))=%%" style="margin:0;padding:0;"><img src="' +
          src +
          '" alt="' +
          alt +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:auto;"></a>\n        </td>\n        <td width="' +
          ...
          "', '?', WAT('nrtag_segment','tile" +
          i +
          '-2\')))=%%" style="margin:0;padding:0;"><img src="' +
          src2 +
          '" alt="' +
          alt2 +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:auto;"></a>\n         </td>\n         <td width="' +
          ...
          "', '?', WAT('nrtag_segment','tile" +
          i +
          '-3\')))=%%" style="margin:0;padding:0;"><img src="' +
          src3 +
          '" alt="' +
          alt3 +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:auto;"></a>\n        </td>\n     </tr>\n</table>\n';
      ...
      case 4:
        ...
        height4 = document.getElementById('my-image-' + rowIndex4)
          .naturalHeight;
        // Compile the table code for this row of inputs
        tableRow[i] =
          '<table class="row collapse w100P" border="0" cellspacing="0" cellpadding="0" width="640" style="border-collapse:collapse;border-spacing:0;padding:0;vertical-align:top;width:100%;">\n    <tr>\n       <td width="' +
          ...
          "', '?', WAT('nrtag_segment','tile" +
          i +
          '-4\')))=%%" style="margin:0;padding:0;"><img src="' +
          src4 +
          '" alt="' +
          alt4 +
          '" style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;max-width:100%;outline:0;width:auto;"></a>\n        </td>\n     </tr>\n</table>\n';
...
function copyButton() {
  ...
  document.getElementById('copy-button').innerHTML =
    '<button class="btn btn-success" id="btn-copy" onclick="copyClipboard()">Copy to Clipboard</button><button style="margin-left:20px;" class="btn btn-outline-dark" id="btn-init" onclick="init()">Reset</button>';
}
...
function handleImage(p) {
  ...
  if (src != '') {
    imgTemplate =
      '<img src="' +
      src +
      '" onload="this.width/=1.5;" id="my-image-' +
      p +
      '" />';
  } else {
    imgTemplate = '';
